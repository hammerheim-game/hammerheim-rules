...
| D6 | Result | Difficulty | Type | Effect |
| :-: | :-: | :-: | :-: | :-: |
| 1 | Regeneration | Auto | n/a |After the game the Priest may Heal a single permanent injury from any warband member. Alternatively this spell may be used in the same way as Medical Knowledge. |
...
lacking the tradition of sorcery and the grimoires of Necromancers and Chaos Mages, have to rely on their own natural aptitude and experimentation. Lesser Magic (or hedge magic) is used by human warlocks, though can be used by experimental researchers curious to study its effects. It may not be as awesome as the mighty spells of Necromancers and Chaos Mages, but it is still dangerous.
