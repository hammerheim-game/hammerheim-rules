...
| 3 | Soulfire | 9 | Direct Damage. | Purifying white flames burst from the caster, smiting their foes but leaving allies unharmed. All enemy models within 4" of the scaster suffer a Strength 3 hit with armour saves are allowed. Undead and Possessed models in range suffer a Strength 5 hit instead. |
...
| 6 | Armour of Righteousness | 9 | Augment. | Sigmar's blessings strengthen in direct proportion to one's willpower and belief, a Priest who wholly believes that they will come to no harm will not. The caster gains a 4+ Ward Save that lasts until they take a wound. |
...
Unlike most schools of prayer Taal Priests may never wears armour.
...
| 2 | The Living Shadows | 7 | Direct Damage. | Shadows around the target suddenly writhe as if alive and move to strike the victim. The Shadow Weaver may cast this spell at any enemy model within 12" of the caster and within 2" of a wall. The target suffers a single Strength 4 hit with no armour saves. |
...
| 4 | Pestilence | 10 | Direct Damage. | The Master inflicts horrible diseases upon the unbelievers. All enemy models within 12" of the Master suffer a Strength 2 hit. No Armour saves are allowed. |
...
| D6 | Result | Difficulty | Type | Effect |
| :-: | :-: | :-: | :-: | :-: |
| 1 | Wither | 8 | Direct Damage. | The power of pestilence suffuses the hands of the Chanter, bringing contagion and suffering to the touch. The Chanter selects one model in base contact. This model suffers D3 Strength 6 hits, with no armour save possible. |
| 2 | Children of the Horned Rat | Auto | n/a | The Sorcerer raises his paws and calls upon the Father of the Skaven to send forth his servants. This spell must be used before the game, and may only be used once. When cast, the spell summons D3 Giant Rats, which are placed within 6” of the Sorcerer. The Sorcerer may cast this spell successfully only once per battle, and the rats disappear after the battle. They do not count toward the maximum size of the Skaven warband. |
...
| 4 | Poisoned Wind | 9 | Direct Damage. | The Warlock expels an acidic cloud that coats his enemies, melting them into nothing. The Warlock places the Breath Weapon template with the tip touching the model. Any model touched by the template takes D3 wounds on a roll of 5+, with no armour save possible.
...
| 2 | Stiff Pelt | 6 | Augment. | The shaman casts this spell on a single wolf within 12", causing the wolf’s pelt to grow thick and stiff for the spell's duration. The wolf gains a special 4+ armour save that is not modified in any way. The spell remains in effect until the wolf is wounded. The spell can be cast on multiple wolves in successive rounds. |
